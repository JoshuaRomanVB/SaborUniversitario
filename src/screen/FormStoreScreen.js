...
export default function FormStoreScreen(props) {
  ...
  const description =
    dataStore === undefined ? undefined : dataStore.description;
  ...
  function validationSchema() {
    return {
      ...
      storeDescription: Yup.string().required(
        "La descripción de tienda es obligatoria"
      ),
      schoolStore: Yup.string()
        .required("La escuela es obligatoria")
        .max(6, "Escribe un máximo de 6 letras")
        .min(3, "Escribe un mínimo de 3 letras"),
    };
  }
      ...
      <ScrollView style={{ backgroundColor: "#fff" }}>
        ...
        <View style={styles.screenContent}>
          ...
          <Input
            ...
            iconName="copy"
            onChangeText={(text) =>
              formik.setFieldValue("storeDescription", text)
            }
          />
          ...
          <View style={styles.contentBtnOption}>
            <CustomButton
              title={dataStore != undefined ? "Actualizar tienda" : "Guardar"}
