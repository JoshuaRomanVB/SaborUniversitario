...
export default function FormProductScreen(props) {
  ...
  const name_product =
    dataProduct === undefined ? undefined : dataProduct.name_product;
  ...
  function validationSchema() {
    return {
      ...
      productPrice: Yup.number("El precio debe de ser numérico")
        .required("El precio es obligatorio")
        .positive("El precio debe de ser un número positivo"),
    };
  }
      ...
      <ScrollView style={{ backgroundColor: "#fff" }}>
        ...
        >
          ...
          <Text style={styles.textTitle}>
            {name_product != undefined
              ? `Actualizar producto: ${name_product}`
              : "Crear producto"}{" "}
          </Text>
          </View>
        </ImageBackground>
        <View style={styles.screenContent}>
          ...
          <View style={styles.contentBtnOption}>
            <CustomButton
              title={
                dataProduct != undefined ? "Actualizar producto" : "Guardar"
              }
